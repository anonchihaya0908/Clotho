...
export class ClangFormatPreviewProvider implements vscode.TextDocumentContentProvider {
    ...
    public createPreviewUri(filename: string = 'macro-preview.cpp'): vscode.Uri {
        ...
        const uri = vscode.Uri.parse(`${ClangFormatPreviewProvider.SCHEME}://clang-format/${filename}?t=${timestamp}`);
     ...
     * @param context 扩展上下文
     */
    public static register(context: vscode.ExtensionContext): ClangFormatPreviewProvider {
