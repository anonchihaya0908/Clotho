...
export const CONFIG_TEMPLATES = {
    ...
    modern_cpp: {
        ...
        config: {
            ...
            searchPaths: ['.', '../include', '../src', './include', './src', '../api'],
    ...
    cmake_project: {
        ...
        config: {
            ...
            testDirs: ['tests', 'test'],
            searchPaths: ['.', '../include', '../src', './include', './src'],
            excludePatterns: [...DEFAULT_SWITCH_CONFIG.excludePatterns, '**/CMakeFiles/**']
        } as SwitchConfig
    },
    ...
    enterprise: {
        ...
        config: {
            ...
            searchPaths: ['.', '../include', '../src', './include', './src', '../../common/include'],
            excludePatterns: DEFAULT_SWITCH_CONFIG.excludePatterns
        } as SwitchConfig
    }
};
...
export class SwitchConfigService {
     ...
     * 应用配置模板
     */
    public static async applyTemplate(templateKey: keyof typeof CONFIG_TEMPLATES): Promise<void> {
    ...
    public static async showTemplateSelector(): Promise<void> {
        ...
        const items: TemplateQuickPickItem[] = Object.entries(CONFIG_TEMPLATES).map(([key, template]) => ({
        ...
        const selected = await vscode.window.showQuickPick(items, {
            placeHolder: 'Select a configuration template for header/source switching',
