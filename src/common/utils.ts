 ...
 */
export function getWorkspaceFolder(uri: Uri): vscode.WorkspaceFolder | undefined {
 ...
 */
export function detectLanguageFromLanguageId(languageId: string): Language | null {
    switch (languageId) {
        case 'c': return 'c';
        case 'cpp': return 'cpp';
        default: return null;
